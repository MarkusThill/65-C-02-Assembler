================================================================================
    MICROSOFT FOUNDATION CLASS-BIBLIOTHEK: SerMosSPS-Projektübersicht
===============================================================================

Der Anwendungs-Assistent hat diese SerMosSPS-Anwendung für Sie 
...
finden, aus denen Ihre SerMosSPS–Anwendung besteht.
...
SerMosSPS.h
    ...
    die CSerMosSPSApp-Anwendungsklasse.

SerMosSPS.cpp
    Dies ist die Hauptquelldatei der Anwendung, die die CSerMosSPSApp-
...
res\SerMosSPS.ico
    ...
    Dieses Symbol ist in der Hauptressourcendatei "SerMosSPS.rc" 
    enthalten.
...
SerMosSPSDlg.h, SerMosSPSDlg.cpp – das Dialogfeld
    Diese Dateien enthalten Ihre CSerMosSPSDlg–Klasse. Diese Klasse 
    bestimmt das Verhalten des Hauptdialogfelds Ihrer Anwendung. Die Vorlage des 
    Dialogfelds befindet sich in der Datei "SerMosSPS.rc", die in 
...
"StdAfx.h", "StdAfx.cpp"
    ...
    (PCH-Datei) mit dem Namen "SerMosSPS.pch.pch2 und eine 
